...
class Attendance {
    ...
    String line(){ return String.format("%s | Jadwal %s | Datang %s | %s",
...
abstract class Participant {
    ...
    String info(){ return String.format("[%s] %s (%s) | Tol %d min, Max %d min",
            id, name, role(), grace(), maxLate()); }
}
...
public class Main {
    ...
    static void showLogs(){
        ...
        else for(Attendance r : p.log) System.out.println(r.line());
